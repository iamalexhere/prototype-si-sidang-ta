...
const tataTulis = document.getElementById('tataTulis');
const kelengkapanMateri = document.getElementById('kelengkapanMateri');
const prosesBimbingan = document.getElementById('prosesBimbingan');
const penguasaanMateri = document.getElementById('penguasaanMateri');
