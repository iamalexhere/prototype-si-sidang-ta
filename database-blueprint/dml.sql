...
(2, 1, 'Implementasi protokol transfer data multiple frame/packet yang reliable di Wireless Sensor Network bertopologi flat', 'ELH5801ACS', 'skripsi1', 'draft'),
(3, 1, 'Visualisasi Graf Interaksi Pengguna Twitter', 'MTA5801BCS', 'skripsi1', 'draft'),
(4, 1, 'Pengembangan aplikasi pemantauan getaran menggunakan Eclipse Paho MQTT Python client library', 'ELH5806CCS', 'skripsi1', 'draft');
